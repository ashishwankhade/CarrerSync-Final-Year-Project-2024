...
const details={
  jobtitle:"Google WebDev",
  jobdesc:"This is job desc for the job of google webdev."
}
    ...
    <>
      <div class="md:grid md:grid-cols-3 h-fit gap-4 grid-col-1 mt-2 ">
        <div class="col-span-1 py-6 md:px-8 px-4 bg-white dark:bg-[#1E293B] rounded-lg w-full h-fit mb-6">
          ...
          <div class="grid grid-cols-1 content-center py-4 mb-2 ">
            ...
            <div className="flex  justify-between border-dashed border-gray-900/10 dark:border-gray-600 border-b-2 pb-2 mb-3">
              ...
              <div className=""> April 30,2023</div>
            </div>
            <div className="flex  justify-between border-dashed border-gray-900/10  dark:border-gray-600 border-b-2 pb-2 mb-3">
              <div className="">Experience :</div>
              <div className=""> 2yrs Exp</div>
            </div>
            <div className="flex  justify-between border-dashed border-gray-900/10 dark:border-gray-600 border-b-2 pb-2 mb-3">
              <div className="">Salary :</div>
              <div className=""> 200k</div>
            </div>
        ...
        <div class="col-span-2 py-6 md:px-7 px-4 h-fit  bg-white dark:bg-[#1E293B] rounded-lg ">
          ...
          <div className= "">
            <div className="">
              <p className="block text-lg font-medium text-gray-900 dark:text-white  mt-3 ">Company Name : {details.jobtitle}</p>
              <p className="block text-lg font-medium text-gray-900 dark:text-white mt-2 mb-2">Description</p>
              <p className=" text-justify mb-4">
                We are Looking For a PHP Doveloper, who is must be familiar with
                the PHP fundamentals& PHP framwork. Experience with Laravel &
                mixs, Livewire Good knowledge of SQL and related databases, with
                a preference for those with MySQL experience. Excellent
                knowledge of the basic PHP 7 or web server exploits along with
                their solutions. Experience building or maintaining a CMS.
                Knowledge of MVC frameworks. A detailed understanding of
                database design and administration. The ability to integrate a
                variety of data sources and databases into a single system.
                {/* {details.jobdesc} */}
              </p>

              <div className="">
               <p className=" block text-lg font-medium text-gray-900 dark:text-white">Website Link : </p> <a href="" />
              </div>
             
              <div className="line mt-4 border border-gray-900/10 dark:border-[#4F46E5] opacity-50"></div>

              <p className="block text-lg font-medium text-gray-900 dark:text-white  mt-3">Job Title : Frontend Webdev</p>
              <p className="block text-lg font-medium text-gray-900 dark:text-white mt-2 mb-2">Job Description</p>
            ...
            <div className="flex  justify-between border-dashed border-gray-900/10 dark:border-gray-600 border-b-2 pb-2 mb-3">
              ...
              <div className=""> B.E / B.Tech </div>
            </div>
            <div className="flex  justify-between border-dashed border-gray-900/10 dark:border-gray-600 border-b-2 pb-2 mb-3">
              <div className="">Skills Required : </div>
              <div className=""> HTML,CSS,JAVASCIPT  </div>
            </div>
            <div className="flex  justify-between border-dashed border-gray-900/10 dark:border-gray-600 border-b-2 pb-2 mb-3">
              <div className="">Job Type :</div>
              <div className=""> Full-Type</div>
          ...
          <div className="line mt-4 border border-gray-900/10 dark:border-[#4F46E5] opacity-50"></div>
          <p className="block text-lg font-medium text-gray-900 dark:text-white mt-3 mb-2">Selection Process</p>
              <p className=" text-justify mb-2">
                We are Looking For a PHP Doveloper, who is must be familiar with
                the PHP fundamentals& PHP framwork. Experience with Laravel &
                mixs, Livewire Good knowledge of SQL and related databases, with
              ...
              <div className="line mt-4 border border-gray-900/10 dark:border-[#4F46E5] opacity-50"></div>
              <p className="block text-lg font-medium text-gray-900 dark:text-white mt-2 mb-2">Terms and conditions of employment:</p>
              <p className=" text-justify mb-2">
                We are Looking For a PHP Doveloper, who is must be familiar with
                the PHP fundamentals& PHP framwork. Experience with Laravel &
                mixs, Livewire Good knowledge of SQL and related databases, with
              ...
              <div className="line mt-4 border border-gray-900/10 dark:border-[#4F46E5] opacity-50"></div>
              <div className="">
               <p className=" block text-lg font-medium text-gray-900 dark:text-white mt-3">Website Link : </p> <a href="" />
              </div>

              <p className="block text-lg font-medium text-gray-900 dark:text-white mt-3">Deadline for Registration : 23/3/2024</p>
