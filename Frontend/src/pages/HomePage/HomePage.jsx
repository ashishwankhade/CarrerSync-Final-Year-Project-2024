    ...
    return (
      ...
      <>
        ...
        <Navbar/>
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-20 pb-10 relative top-0 ">
            ...
            <div className="mt-5  text-center mx-auto">
              ...
              Matching Skills with <br/> 
                <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent " ref={el}/>
              </h1>
            </div>
            {/* End Title */}
  
            <div className="mt-5 max-w-4xl text-center mx-auto">
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-32">Elevate your career journey with CarrerSync Job Placement Portal, where endless opportunities meet your ambition. Connect, explore, and secure your dream job through a platform designed for your success.</p>
          ...
          <h2 className='text-medium text-md text-center text-gray-600 dark:text-gray-400'>All rights Reserverd CarrerSync 2024.</h2>
          </div>
        </div>
