  ...
  return Promise.resolve([
    {
      ...
      "Local Address":
        "NH 6, Opposite Nemani Godown, Nimbora, Badnera Rd, Amravati, Maharashtra 444701 Hostel rani lashami bai",
    ...
    },
    {
      ...
      "Local Address":
        "77B Thakurwadi, Near Avatar Meher Baba Center, Amravati",
      "Permanent Address":
        "77B Thakurwadi, Near Avatar Meher Baba Center, Amravati",
      University: "S.G.B.A.U., Amravati",
    ...
    },
    {
      ...
      "Local Address":
        "B-6 Rukhmini Appartment, Ambika Nagar, near Ganesh mandir Rukhmini nagar Amravati Maharashtra India 444606",
      "Permanent Address":
        "B-6 Rukhmini Appartment, Ambika Nagar, near Ganesh mandir Rukhmini nagar Amravati Maharashtra India 444606",
      University: "S.G.B.A.U., Amravati",
    ...
    },
    {
      ...
      "Local Address":
        "Dhanwadi , po. Bhandaraj, tq. Anjangaon surji , Amravati",
      "Permanent Address":
        "Dhanwadi , po. Bhandaraj, tq. Anjangaon surji , Amravati",
      University: "S.G.B.A.U., Amravati",
    ...
    },
    {
      ...
      "Local Address":
        "Nawathe Garden, Opposite Dasera Maidan, Badnera Road, Amravati",
      "Permanent Address":
        "Nawathe Garden, Opposite Dasera Maidan, Badnera Road, Amravati",
      University: "S.G.B.A.U., Amravati",
      "Skill Set": "Python",
    ...
    },
    {
      ...
      "Permanent Address":
        "Tulshibagar Kali dk taluka mahagao district yavatmal",
      University: "S.G.B.A.U., Amravati",
      "Skill Set": "Java html css",
    ...
    },
    {
      ...
      "Permanent Address":
        "Takarkheda Purna post -Asegaon Purna Tq-Chandur Bazar Dist-Amravati",
      University: "S.G.B.A.U., Amravati",
      "Skill Set": "C,Python",
    ...
    <>
      ...
      <div class="relative overflow-x-auto overflow-y-auto  shadow-md sm:rounded-lg ">
        <table class="w-full text-sm text-left  text-gray-500 bg-red-500 dark:bg-[#1E293B] ">
          <thead class="text-sm bg-indigo-500  dark:text-white w-full whitespace-nowrap text-white">
          ...
          <tbody>
            {currentItems.map((Data, index) => (
              <tr
                key={index}
                class="bg-white border-b dark:bg-gray-800   whitespace-nowrap text-center"
              >
