          ...
          <div>
            ...
            <ul className="mt-3">
             ...
             <SidebarLinkGroup activecondition={pathname.includes('activejobs')}>
              ...
              {/* Calendar */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('studentdata') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="studentdata"
                  className={({ isActive }) =>
                ...
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path className={`fill-current ${pathname.includes('studentdata') ? 'text-indigo-500' : 'text-slate-600'}`} d="M1 3h22v20H1z" />
                      <path
