...
<div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 ">
      <div className="px-5 py-4 ">
        <header className="flex justify-start items-center mb-2">
          ...
          <h2 className="text-md font-semibold text-slate-800 dark:text-slate-100 ml-2">Date and Time</h2>
        </header>
        <div className='flex items-center '>
          <div className='relative w-full pl-9'>
              <h2 className="text-md font-bold text-slate-500 dark:text-slate-100 ">{currentDate}</h2>
              <h2 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-2 ">{currentTime}</h2>
